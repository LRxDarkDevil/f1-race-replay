    ...
    if session_type == "Q" or session_type == "SQ":
            ...
            if quali_session is not None and len(quali_session.laps) > 0:
                ...
                if fastest_quali is not None:
                    ...
                    if "DRS" in quali_telemetry.columns:
                        ...
                        print(
                            f"Using qualifying lap from driver {fastest_quali['Driver']} for DRS Zones"
                        )
        ...
        if example_lap is None:
            ...
            if fastest_lap is not None:
                ...
                print(
                    "Using fastest race lap (DRS detection may use speed-based fallback)"
                )
            else:
        ...
        session_info = {
            ...
            "year": year,
            "round": round_number,
            "date": session.event.get("EventDate", "").strftime("%B %d, %Y")
        ...
        run_arcade_replay(
            ...
            pit_stops=race_telemetry.get("pit_stops"),
        )
    ...
    if "--viewer" in sys.argv:
        ...
        session_type = (
            ...
            if "--sprint-qualifying" in sys.argv
                ...
                else ("Q" if "--qualifying" in sys.argv else "R")
            )
        )
